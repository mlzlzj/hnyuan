...
shengshi_names = ["长沙", "娄底", "衡阳", "常德", "梅州", "肇庆", "周口", "濮阳", "安阳", "平顶山", "贵港", "南宁", "邯郸",
                  "玉林", "保定", "山东", "包头", "金华", "厦门", "湖北", "揭阳", "揭西", "五华", "北流"]
...
# 合并所有的txt文件
file_contents = []
file_paths = ["YD-IPTV.txt", "iptv_list.txt", "huoqu.txt", "zdy.txt"]  # 替换为实际的文件路径列表
